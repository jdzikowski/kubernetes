...
// hierarchyTrackerImpl implements fwk.HierarchyTracker with an in-memory index protected by an RWMutex
...
var _ fwk.HierarchyTracker = &hierarchyTrackerImpl{}

// NewHierarchyTracker returns a new thread-safe HierarchyTracker.
func NewHierarchyTracker() fwk.HierarchyTracker {
