...
var map_CompositePodGroupSpec = map[string]string{
	...
	"workloadRef":                 "WorkloadRef references an optional CompositePodGroup template within the Workload object that was used to create the CompositePodGroup. This field is required.",
...
var map_CompositePodGroupTemplate = map[string]string{
	...
	"compositePodGroupTemplates": "CompositePodGroupTemplates is the list of templates for children CompositePodGroups. The maximum number of templates is 8.",
	"podGroupTemplates":          "PodGroupTemplates is the list of templates for children PodGroups. The maximum number of templates is 8.",
}
...
var map_WorkloadReference = map[string]string{
	...
	"workloadName": "WorkloadName is the name of the Workload object that contains a template that was used when creating a pod group or a composite pod group. It must be a DNS name. This field is required.",
	"templateName": "TemplateName is the name of a template within the Workload object that was used to create a pod group or a composite pod group. It must be a DNS label. This field is required.",
}
